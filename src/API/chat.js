...
const getGroups = async (accessToken) => { 
    try {
        const response = await axios.get(`${domain}chat/groups/`, {
            headers: {
...
const getGroupMessages = async (groupId, accessToken) => {
    try {
        const response = await axios.get(`${domain}chat/messages/group/${groupId}/`, {
            headers: {
                Authorization: `Bearer ${accessToken}`
            }
        });
...
const getUserMessages = async (userId, accessToken) => {
    try {
        const response = await axios.get(`${domain}chat/messages/private/${userId}/`, {
            headers: {
                Authorization: `Bearer ${accessToken}`
            }
        });
...
const getAllPrivateChats = async (accessToken) => {
    try {
        const response = await axios.get(`${domain}chat/private-chats/`, {
            headers: {
                Authorization: `Bearer ${accessToken}`
            }
        });
...
const sendMessage = async (messageData, accessToken) => {
    try {
        const response = await axios.post(`${domain}chat/messages/`, messageData, {
            headers: {
                Authorization: `Bearer ${accessToken}`
            }
        });
...
const createGroupChat = async (groupData, accessToken) => {
    try {
        const response = await axios.post(`${domain}chat/groups/`, groupData, {
            headers: {
                Authorization: `Bearer ${accessToken}`
            }
        });
...
const getGroupMembers = async (groupId, accessToken) => {
    try {
        const response = await axios.get(`${domain}chat/groups/${groupId}/members/`, {
            headers: {
                Authorization: `Bearer ${accessToken}`
            }
        });
...
export const sendEmail = async (data, accessToken) => {
    ...
    const response = await axios.post(`${domain}chat/send-email/`, formData, {
        headers: {
            'Authorization': `Bearer ${accessToken}`,
